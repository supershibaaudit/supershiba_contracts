...
// MasterChef is the master of Treats. He can make Treats and he is a fair guy.
//
...
contract MasterChef is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 accEggPerShare;   // Accumulated Treats per share, times 1e12. See below.
        uint16 depositFeeBP;      // Deposit fee in basis points
    }

    // The Treats TOKEN!
    TreatsToken public egg;
    // Dev address.
    ...
    // View function to see pending TreatsToken on frontend.
    ...
    // Safe egg transfer function, just in case if rounding error causes pool to not have enough Treats.
